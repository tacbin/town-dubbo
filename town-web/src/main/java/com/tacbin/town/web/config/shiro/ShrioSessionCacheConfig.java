...
import com.tacbin.town.web.config.shiro.session.MyShiroSessionListener;
...
@Configuration
public class ShrioSessionCacheConfig {
    @Autowired
     ...
     */
    @Bean
    public MyShiroSessionListener sessionListener() {
        MyShiroSessionListener sessionListener = new MyShiroSessionListener();
